const validationNote = (event) => {
    ...
    titleNoteInput.addEventListener('blur', (event) => {
        ...
        const connectedValidationId = titleNoteInput.getAttribute('aria-describedby');
    
        const connectedValidationEl = connectedValidationId ? form.querySelector(`#${connectedValidationId}`) : null;
    ...
    bodyNoteInput.addEventListener('blur', (event) => {
        ...
        const connectedValidationId = bodyNoteInput.getAttribute('aria-describedby');
